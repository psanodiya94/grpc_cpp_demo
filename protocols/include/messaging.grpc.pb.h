 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status ReceiveMessage(::grpc::ClientContext* context, const ::message::MessageRequest& request, ::message::MessageReply* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::MessageReply>> AsyncReceiveMessage(::grpc::ClientContext* context, const ::message::MessageRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::MessageReply>>(AsyncReceiveMessageRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::MessageReply>> PrepareAsyncReceiveMessage(::grpc::ClientContext* context, const ::message::MessageRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::MessageReply>>(PrepareAsyncReceiveMessageRaw(context, request, cq));
    }
    class async_interface {
     public:
      ...
      virtual void ReceiveMessage(::grpc::ClientContext* context, const ::message::MessageRequest* request, ::message::MessageReply* response, std::function<void(::grpc::Status)>) = 0;
      virtual void ReceiveMessage(::grpc::ClientContext* context, const ::message::MessageRequest* request, ::message::MessageReply* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::message::MessageReply>* AsyncReceiveMessageRaw(::grpc::ClientContext* context, const ::message::MessageRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::message::MessageReply>* PrepareAsyncReceiveMessageRaw(::grpc::ClientContext* context, const ::message::MessageRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status ReceiveMessage(::grpc::ClientContext* context, const ::message::MessageRequest& request, ::message::MessageReply* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::MessageReply>> AsyncReceiveMessage(::grpc::ClientContext* context, const ::message::MessageRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::MessageReply>>(AsyncReceiveMessageRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::MessageReply>> PrepareAsyncReceiveMessage(::grpc::ClientContext* context, const ::message::MessageRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::MessageReply>>(PrepareAsyncReceiveMessageRaw(context, request, cq));
    }
    class async final :
     ...
     public:
      ...
      void ReceiveMessage(::grpc::ClientContext* context, const ::message::MessageRequest* request, ::message::MessageReply* response, std::function<void(::grpc::Status)>) override;
      void ReceiveMessage(::grpc::ClientContext* context, const ::message::MessageRequest* request, ::message::MessageReply* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::message::MessageReply>* AsyncReceiveMessageRaw(::grpc::ClientContext* context, const ::message::MessageRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::message::MessageReply>* PrepareAsyncReceiveMessageRaw(::grpc::ClientContext* context, const ::message::MessageRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status ReceiveMessage(::grpc::ServerContext* context, const ::message::MessageRequest* request, ::message::MessageReply* response);
  };
  ...
  class WithAsyncMethod_ReceiveMessage : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status ReceiveMessage(::grpc::ServerContext* /*context*/, const ::message::MessageRequest* /*request*/, ::message::MessageReply* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestReceiveMessage(::grpc::ServerContext* context, ::message::MessageRequest* request, ::grpc::ServerAsyncResponseWriter< ::message::MessageReply>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(1, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_SendMessage<WithAsyncMethod_ReceiveMessage<Service > > AsyncService;
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_ReceiveMessage() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::message::MessageRequest, ::message::MessageReply>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::message::MessageRequest* request, ::message::MessageReply* response) { return this->ReceiveMessage(context, request, response); }));}
    void SetMessageAllocatorFor_ReceiveMessage(
        ::grpc::MessageAllocator< ::message::MessageRequest, ::message::MessageReply>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* ReceiveMessage(
      ::grpc::CallbackServerContext* /*context*/, const ::message::MessageRequest* /*request*/, ::message::MessageReply* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_SendMessage<WithCallbackMethod_ReceiveMessage<Service > > CallbackService;
  ...
  class WithRawMethod_ReceiveMessage : public BaseClass {
   ...
   public:
    ...
    void RequestReceiveMessage(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(1, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
   ...
   public:
    WithRawCallbackMethod_ReceiveMessage() {
      ::grpc::Service::MarkMethodRawCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->ReceiveMessage(context, request, response); }));
    }
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_ReceiveMessage : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_ReceiveMessage() {
    ...
    ~WithStreamedUnaryMethod_ReceiveMessage() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status ReceiveMessage(::grpc::ServerContext* /*context*/, const ::message::MessageRequest* /*request*/, ::message::MessageReply* /*response*/) override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedReceiveMessage(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::message::MessageRequest,::message::MessageReply>* server_unary_streamer) = 0;
  };
  typedef WithStreamedUnaryMethod_SendMessage<WithStreamedUnaryMethod_ReceiveMessage<Service > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_SendMessage<WithStreamedUnaryMethod_ReceiveMessage<Service > > StreamedService;
};
